...
module.exports = {
  ...
  "nav-single-button": "nav-single-button",
  "nav-two-buttons": "nav-two-buttons",
  "navbar": "navbar",
  "menu": "menu",
  "menu-item": "menu-item",
  "rheroicons-logout": "rheroicons-logout",
  ...
  "filled-page-background": "filled-page-background",
  "page": "page",
  "fadeIn": "fadeIn",
  "rheroicons-outline": "rheroicons-outline",
  "results-title": "results-title",
  "error-box": "error-box",
  "error-box-text": "error-box-text",
  "signin-page": "signin-page",
  "signin-form": "signin-form",
  "signin-form-title": "signin-form-title",
  "signin-icon": "signin-icon",
  "password": "password",
  "username": "username",
  "login": "login",
  ...
  "card": "card",
  "side-effect-cards": "side-effect-cards",
  ...
  "rheroicons-check": "rheroicons-check",
  "rheroicons-exclamation": "rheroicons-exclamation",
  "screen-reader-text": "screen-reader-text",
  "bar-container": "bar-container",
  "bar": "bar",
  "revealable-content": "revealable-content",
  "revealable-expanded": "revealable-expanded",
  "side-effects-selection": "side-effects-selection",
  "filled-fieldset": "filled-fieldset",
...
function toggle_definition(id) {
  // get elements
  var section = document.querySelector(".card-content[data-group='".concat(id, "']"));
  var btn = document.querySelector("button[data-group='".concat(id, "'"));
  var open = btn.getAttribute("aria-expanded") === true; // modify attributes and classes
...
Shiny.addCustomMessageHandler("select_effect", function (data) {
  document.querySelector(".card[data-group=".concat(data.id, "]")).classList.add("selected");
});
Shiny.addCustomMessageHandler("deselect_effect", function (data) {
  document.querySelector(".card[data-group=".concat(data.id, "]")).classList.remove("selected");
}); // reset side effects
...
function reset_side_effects() {
  ...
  var toggles = document.querySelectorAll(".card-toggle"); // cards: remove any focus states and selected classes from cards
...
function updateProgressBar(el, now, max) {
  ...
  elem.style.transform = "scaleX(".concat(d.transform_value, ")");
  elem.style.transformOrigin = "".concat(d.rate, " center");
} // updateProgressBar

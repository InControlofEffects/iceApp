    ...
    tags$section(class = "page",
        ...
        tags$form(
            ...
            card_input(
                id = "weight",
                title = "Weight Gain",
                text = "Some antipsychotic medications may lead you to put on weight through an increase in appetite and a recurring feeling of hunger."
            ),
            ...
            card_input(
                ...
                text = "Some antipsychotic medications can cause changes to the pace or rhythm of heartbeats. In some cases, this can lead to dizziness, shortness of breath, and palpitations (a brief period of a noticeable 'fluttering' or a 'pounding' sensation of the heart)."
            ),
            ...
            card_input(
                ...
                text = "Antipsychotic medications act by blocking to a different degree a chemical in the brain called dopamine. Low levels of dopamine may result in difficulties with movement such as stiffness, tremor or sudden muscle spasms. In some cases dopamine blockers can also cause brief periods of extreme feeling of restlessness."
            )
        ),

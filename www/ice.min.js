...
module.exports = {
  ...
  "menu-link": "menu-link",
  "sidebar": "sidebar",
  "sidebar-revealed": "sidebar-revealed",
  ...
  "signin": "signin",
  "form": "form",
  "rheroicons_user_circle": "rheroicons_user_circle",
  ...
  "rheroicons_check": "rheroicons_check",
...
var sidebarBtns = document.querySelectorAll(".sidebar .menu button, .sidebar .menu a"); // toggle sidebar state

function toggle_sidebar() {
  if (_toConsumableArray(sidebar.classList).indexOf("sidebar-revealed") > -1) {
...
sidebarBtns.forEach(function (btn) {
  return btn.addEventListener("click", toggle_sidebar);
}); // menu toggle click
...
var accordionToggle = new Shiny.InputBinding();
$.extend(accordionToggle, {
  ...
  subscribe: function subscribe(el, callback) {
    $(el).on("change.accordionToggle", function (e) {
      ...
      $("section.accordion-section[data-group='".concat(id, "']"))[0].classList.toggle("browsertools-hidden");
    });
  },
...
Shiny.inputBindings.register(accordionToggle); // cue trigger
